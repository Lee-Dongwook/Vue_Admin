...
const cutLists = ref<CutListItem[]>([
  ...
  <el-card shadow="never">
    <template #header>
      ...
      <el-link
        ...
        target="_blank"
      >
        코드링크 src/views/able/draggable.vue
      </el-link>
    </template>
